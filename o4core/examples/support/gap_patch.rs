//! Frozen research copy of optical_patch: only noisy tracking uses two-frame pairs.
use o4core::config::Config;
use o4core::detect::{find_intervals, CleanDiag};
use o4core::dsp;
...
pub fn optical_patch(
    ...
    let opt_n = crate::fb::video_rates(
        video,
        &noisy,
        meta,
        cancel,
        &|d, n| on_interval(OptPhase::Noisy, d, n),
        false,
        0,
        2,
    )?;
